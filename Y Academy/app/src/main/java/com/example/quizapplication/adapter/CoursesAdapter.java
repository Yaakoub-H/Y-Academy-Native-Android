...
public class CoursesAdapter extends RecyclerView.Adapter<CoursesAdapter.AllPopularCoursesViewHolder> {

    private Context context;
    private List<AllPopularCoursesItem> allPopularCoursesList;

    public CoursesAdapter(Context context, List<AllPopularCoursesItem> allPopularCoursesList) {
